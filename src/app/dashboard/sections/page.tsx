    ...
    <div className="p-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-white/40">
            Drag to reorder. Toggle sections on or off to compose your perfect profile.
          </p>
        </div>
        <button
      ...
      {sections.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-white/10 py-24 text-center">
          <LayersIcon className="mx-auto mb-4 h-10 w-10 text-white/20" />
        ...
        <div className="space-y-3">
          {sections.map((section, index) => {
            ...
            return (
              <div
                key={section.id}
                className="group flex items-center gap-3 rounded-2xl border border-white/[0.06] bg-white/[0.03] px-4 py-3.5 transition hover:border-white/[0.12]"
              >
                ...
                <div className="flex items-center gap-2">
                  <span className="rounded-lg bg-white/[0.04] px-2.5 py-1 text-[11px] text-white/30">
                    #{index + 1}
                  </span>
                  <button
              ...
              {availableSections.map((sec) => {
                ...
                return (
                  <button
                    ...
                    className="flex items-center gap-3 rounded-2xl border border-white/[0.06] bg-white/[0.02] p-3.5 text-left transition hover:border-violet-500/30 hover:bg-violet-500/5"
                  >
