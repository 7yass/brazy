          ...
          >
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center rounded-xl border border-white/[0.08] bg-white/[0.04] px-3.5 py-2.5">
                ...
                <input type="text" defaultValue="you" className="ml-1 bg-transparent text-sm text-white outline-none" />
              </div>
              <button className="rounded-xl bg-violet-600 px-4 py-2.5 text-sm font-medium text-white transition-all duration-200 hover:bg-violet-500">Save</button>
            </div>
          </div>
        </div>
