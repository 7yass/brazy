...
const stats = [
  { icon: Eye, label: "Total Views", value: "12,847", change: "+12.5%", trend: "up", color: "text-violet-400", bg: "bg-violet-500/10" },
  { icon: MousePointerClick, label: "Total Clicks", value: "3,291", change: "+8.2%", trend: "up", color: "text-cyan-400", bg: "bg-cyan-500/10" },
  { icon: ArrowUpRight, label: "CTR", value: "25.6%", change: "+2.1%", trend: "up", color: "text-emerald-400", bg: "bg-emerald-500/10" },
  { icon: Globe, label: "Top Referrer", value: "Twitter", change: "34.2%", trend: "up", color: "text-amber-400", bg: "bg-amber-500/10" },
];
    ...
    <div className="p-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-white/40">
            Track your profile views, link clicks, and audience insights.
          </p>
        </div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-5">
          <h2 className="mb-5 text-sm font-semibold text-white">Top Referrers</h2>
                ...
                <div key={ref.source}>
                  ...
                  <div className="h-2 rounded-full bg-white/[0.04] overflow-hidden">
                    <div
                      ...
                      style={{ width: `${pct}%`, backgroundColor: ref.color }}
                    />
                  </div>
                </div>
              );
      ...
      <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-5">
          <h2 className="mb-5 text-sm font-semibold text-white">Devices</h2>
        ...
        <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-5">
          <h2 className="mb-4 text-sm font-semibold text-white">Link Clicks</h2>
          <div className="space-y-2.5">
            {[
              { name: "discord", clicks: 892, platform: "discord" },
              { name: "twitter", clicks: 654, platform: "twitter" },
              { name: "github", clicks: 423, platform: "github" },
              { name: "instagram", clicks: 312, platform: "instagram" },
              { name: "spotify", clicks: 198, platform: "spotify" },
            ].map((link) => {
              const maxClicks = 892;
          ...
          <div className="mt-5 rounded-xl border border-dashed border-white/[0.06] p-4 text-center">
            <p className="text-xs text-white/30">
              Detailed per-link analytics with geographic data available on premium.
            </p>
          </div>
        </div>
      </div>
